...
NETLIST_NAME = 'strong_arm_comp_pex_tb'
...
time, Vsc_mc = OutputParser(CktGraph()).tran(f'{NETLIST_NAME}_Vsc_mc')
_, Voutn_mc = OutputParser(CktGraph()).tran(f'{NETLIST_NAME}_Voutn_mc')
_, Voutp_mc = OutputParser(CktGraph()).tran(f'{NETLIST_NAME}_Voutp_mc')
...
plt.plot(bins_centers, ym_r, c='r', label='$\mathbf{\mu=0.8mV}$ \n $\mathbf{\sigma={6.74mV}}$')
...
# plt.savefig(f'./pics/mc_rise_strong_arm_comp_pex.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(f'./pics/mc_rise_strong_arm_comp_pex.png', format='png', bbox_inches='tight')
...
plt.plot(bins_centers, ym_f, c='r', label='$\mathbf{\mu=0.74mV}$ \n $\mathbf{\sigma={6.79mV}}$')
...
ax.spines['right'].set_linewidth(2)
ax.spines['top'].set_linewidth(2)
# plt.savefig(f'./pics/mc_fall_strong_arm_comp_pex_small.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(f'./pics/mc_fall_strong_arm_comp_pex_small.png', format='png', bbox_inches='tight')
