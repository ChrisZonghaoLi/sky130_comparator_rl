...
with open(f'/autofs/fs1.ece/fs1.eecg.tcc/lizongh2/sky130_comparator/comparator_transfer_learning/pex/simulations/double_tail_comp_pex_tb.spice', "r") as netlist:
...
open(f'/autofs/fs1.ece/fs1.eecg.tcc/lizongh2/sky130_comparator/comparator_transfer_learning/pex/simulations/double_tail_comp_pex_tb.spice', "w").close()
# overwrite the PEX testbench netlist for including RC extracted comparator
with open(f'/autofs/fs1.ece/fs1.eecg.tcc/lizongh2/sky130_comparator/comparator_transfer_learning/pex/simulations/double_tail_comp_pex_tb.spice', "w") as netlist:
...
f = open('/autofs/fs1.ece/fs1.eecg.tcc/lizongh2/sky130_comparator/comparator_transfer_learning/pex/simulations/double_tail_comp_pex_tb_vars.spice','w+')
text =  \
f'''{Vcm}
{VDD}
{Vin}
