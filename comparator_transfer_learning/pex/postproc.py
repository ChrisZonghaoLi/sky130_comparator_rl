...
# RGCN
# file_name1 = 'TL_memory_GraphDoubleTailComp_2024-03-05_noise=uniform_reward=11.192_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1'
# file_name2 = 'TL_memory_GraphDoubleTailComp_2024-03-05_noise=uniform_reward=11.209_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1'
# file_name3 = 'TL_memory_GraphDoubleTailComp_2024-03-05_noise=uniform_reward=11.211_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1'
file_name1 = 'TL_memory_GraphDoubleTailComp_2024-03-09_noise=uniform_reward=11.121_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1_test=True'
file_name2 = 'TL_memory_GraphDoubleTailComp_2024-03-09_noise=uniform_reward=11.115_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1_test=True'
file_name3 = 'TL_memory_GraphDoubleTailComp_2024-03-09_noise=uniform_reward=11.139_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1_test=True'

# No TL
file_name4 = 'TL=False_memory_GraphDoubleTailComp_2024-03-07_noise=uniform_reward=-0.248_ActorCriticRGCN_initial_random_steps=0_noise_sigma_decay=1'
...
plt.savefig(f'./pics/tl_reward_sky130_pex_double_tail_comp_small.pdf', format='pdf', bbox_inches='tight')
plt.savefig(f'./pics/tl_reward_sky130_pex_double_tail_comp_small.png', format='png', bbox_inches='tight')

rgcn_best = np.array([np.max(np.mean([rews_buf1, rews_buf2, rews_buf3], axis=0)[0:i]) for i in range(1,1+len(rgcn_mean))])
no_tl_best = np.array([np.max(np.mean([rews_buf4, rews_buf5, rews_buf6], axis=0)[0:i]) for i in range(1,1+len(rgcn_mean))])
...
plt.plot(x,no_tl_best, 'grey', label='Random') # no TL (RGCN) 
...
sim_results = OutputParser(GraphDoubleTailComp(), SPICE_NETLIST_DIR='/autofs/fs1.ece/fs1.eecg.tcc/lizongh2/comparator_transfer_learning/pex/simulations')
time, Vclk = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Vclk'))
_, Voutp = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Voutp'))
_, Voutn = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Voutn'))
...
plt.savefig(f'./pics/clk2q_double_tail_comp_pex_small.pdf', format='pdf', bbox_inches='tight')
plt.savefig(f'./pics/clk2q_double_tail_comp_pex_small.png', format='png', bbox_inches='tight')

# peramp output Vdi
_, Vdip = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Vdip'))
_, Vdin = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Vdin'))
...
# plt.savefig(f'./pics/VDi_double_tail_comp_pex.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(f'./pics/VDi_double_tail_comp_pex.png', format='png', bbox_inches='tight')

# monte-carlo simulations on offset
# See <mc.py>

# kickback noise
_, Vknp = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Vp_kn'))
_, Vknn = np.array(sim_results.tran(file_name='double_tail_comp_pex_tb_Vn_kn'))
...
# plt.savefig(f'./pics/kickback_noise_double_tail_comp_pex.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(f'./pics/kickback_noise_double_tail_comp_pex.png', format='png', bbox_inches='tight')