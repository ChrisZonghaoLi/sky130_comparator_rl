...
def diff_pair(nf_M1, nf_M7, 
      ...
      print(f'M1, M7: {M1}, {M7}')
      print(f'nf_M1, nf_M7: {nf_M1}, {nf_M7}')
      ...
      nf_M2 = nf_M1
      M2 = M1
      in0 = tnmos.generate(name='M7', params={'nf': nf_M7, 'tie': 'S', 'mosfet': M7}) # M7, tail NMOS
      in1 = tnmos.generate(name='M1', params={'nf': nf_M1, 'tie': 'S', 'mosfet': M1}) # M1, input
      in2 = tnmos.generate(name='M2', params={'nf': nf_M2, 'tie': 'S', 'mosfet': M2}) # M2, input
      ...
      extension_M1_drain_v = 3
      mn_M1_drain =  [r23.mn(in1.pins['D'])[0], 
                                      np.array([r23.mn(in1.pins['D'])[1][0] + extension_M1_drain_h, r23.mn(in1.pins['D'])[0][1] + extension_M1_drain_v ])]
      ...
      mn_M2_drain =  [r23.mn(in2.pins['D'])[0], 
                                      np.array([r23.mn(in2.pins['D'])[1][0] - extension_M2_drain_h, r23.mn(in2.pins['D'])[0][1] + extension_M2_drain_v ])]
