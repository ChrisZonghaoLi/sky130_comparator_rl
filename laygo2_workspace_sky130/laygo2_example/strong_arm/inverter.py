...
def inverter(nf_M3, nf_M5, 
      ...
      print(f'M3, M5: {M3}, {M5}')
      print(f'nf_M3, nf_M5: {nf_M3}, {nf_M5}')
      ...
      # nf_M3 = 2
      # nf_M5 = 2
      in0 = tnmos.generate(name='M3', params={'nf': nf_M3, 'tie': 'S', 'mosfet': M3}) # M3
      ip0 = tpmos.generate(name='M5', transform='MX', params={'nf': nf_M5, 'tie': 'S', 'mosfet': M5}) # M5
