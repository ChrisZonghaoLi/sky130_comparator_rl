...
# exporting logic_generated__tinv_small_1x
_laygo2_create_layout ./magic_layout/logic_generated logic_generated_tinv_small_1x sky130A
_laygo2_generate_instance nbndl ./magic_layout/skywater130_microtemplates_dense nmos13_fast_boundary { 0.0  0.0  } R0 1 1 0 0 ; # for the Instance object nbndl 
_laygo2_generate_instance nstack ./magic_layout/skywater130_microtemplates_dense nmos13_fast_center_2stack { 72.0  0.0  } R0 1 1 0 0 ; # for the Instance object nstack 
_laygo2_generate_instance nbndr ./magic_layout/skywater130_microtemplates_dense nmos13_fast_boundary { 216.0  0.0  } R0 1 1 0 0 ; # for the Instance object nbndr 
_laygo2_generate_instance nspace0 ./magic_layout/skywater130_microtemplates_dense nmos13_fast_space { 288.0  0.0  } R0 1 1 0 0 ; # for the Instance object nspace0 
_laygo2_generate_instance nspace1 ./magic_layout/skywater130_microtemplates_dense nmos13_fast_space { 360.0  0.0  } R0 1 1 0 0 ; # for the Instance object nspace1 
_laygo2_generate_instance pbndl ./magic_layout/skywater130_microtemplates_dense pmos13_fast_boundary { 0.0  1008.0  } MX 1 1 0 0 ; # for the Instance object pbndl 
_laygo2_generate_instance pstack ./magic_layout/skywater130_microtemplates_dense pmos13_fast_center_2stack { 72.0  1008.0  } MX 1 1 0 0 ; # for the Instance object pstack 
_laygo2_generate_instance pbndr ./magic_layout/skywater130_microtemplates_dense pmos13_fast_boundary { 216.0  1008.0  } MX 1 1 0 0 ; # for the Instance object pbndr 
_laygo2_generate_instance pspace0 ./magic_layout/skywater130_microtemplates_dense pmos13_fast_space { 288.0  1008.0  } MX 1 1 0 0 ; # for the Instance object pspace0 
_laygo2_generate_instance pspace1 ./magic_layout/skywater130_microtemplates_dense pmos13_fast_space { 360.0  1008.0  } MX 1 1 0 0 ; # for the Instance object pspace1 
_laygo2_generate_rect M3 { { 57.0  345.0  } { 87.0  663.0  } } ; # for the Rect object NoName_0 
_laygo2_generate_rect M1 { { 57.0  350.0  } { 87.0  658.0  } } ; # for the Rect object NoName_1 
_laygo2_generate_instance NoName_2 ./magic_layout/skywater130_microtemplates_dense via_M2_M3_0 { 72.0  504.0  } R0 1 1 0 0 ; # for the Instance object NoName_2 
_laygo2_generate_rect M2 { { 62.0  489.0  } { 226.0  519.0  } } ; # for the Rect object NoName_3 
_laygo2_generate_instance NoName_4 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_0 { 72.0  504.0  } R0 1 1 0 0 ; # for the Instance object NoName_4 
_laygo2_generate_instance NoName_5 ./magic_layout/skywater130_microtemplates_dense via_M2_M3_0 { 216.0  144.0  } R0 1 1 0 0 ; # for the Instance object NoName_5 
_laygo2_generate_rect M3 { { 201.0  129.0  } { 231.0  879.0  } } ; # for the Rect object NoName_6 
_laygo2_generate_instance NoName_7 ./magic_layout/skywater130_microtemplates_dense via_M2_M3_0 { 216.0  864.0  } R0 1 1 0 0 ; # for the Instance object NoName_7 
_laygo2_generate_instance NoName_8 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_0 { 216.0  144.0  } R0 1 1 0 0 ; # for the Instance object NoName_8 
_laygo2_generate_instance NoName_9 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_0 { 216.0  864.0  } R0 1 1 0 0 ; # for the Instance object NoName_9 
_laygo2_generate_rect M2 { { 206.0  345.0  } { 298.0  375.0  } } ; # for the Rect object NoName_10 
_laygo2_generate_instance NoName_11 ./magic_layout/skywater130_microtemplates_dense via_M2_M3_0 { 288.0  360.0  } R0 1 1 0 0 ; # for the Instance object NoName_11 
_laygo2_generate_instance NoName_12 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_0 { 216.0  360.0  } R0 1 1 0 0 ; # for the Instance object NoName_12 
_laygo2_generate_rect M3 { { 273.0  345.0  } { 303.0  663.0  } } ; # for the Rect object NoName_13 
_laygo2_generate_rect M2 { { 134.0  633.0  } { 226.0  663.0  } } ; # for the Rect object NoName_14 
_laygo2_generate_instance NoName_15 ./magic_layout/skywater130_microtemplates_dense via_M2_M3_0 { 144.0  648.0  } R0 1 1 0 0 ; # for the Instance object NoName_15 
_laygo2_generate_instance NoName_16 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_0 { 216.0  648.0  } R0 1 1 0 0 ; # for the Instance object NoName_16 
_laygo2_generate_rect M3 { { 129.0  345.0  } { 159.0  663.0  } } ; # for the Rect object NoName_17 
_laygo2_generate_rect M2 { { -20.0  -30.0  } { 452.0  30.0  } } ; # for the Rect object NoName_18 
_laygo2_generate_rect M1 { { 57.0  -10.0  } { 87.0  154.0  } } ; # for the Rect object NoName_19 
_laygo2_generate_instance NoName_20 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_1 { 72.0  0.0  } R0 1 1 0 0 ; # for the Instance object NoName_20 
_laygo2_generate_rect M2 { { -20.0  978.0  } { 452.0  1038.0  } } ; # for the Rect object NoName_21 
_laygo2_generate_rect M1 { { 57.0  854.0  } { 87.0  1018.0  } } ; # for the Rect object NoName_22 
_laygo2_generate_instance NoName_23 ./magic_layout/skywater130_microtemplates_dense via_M1_M2_1 { 72.0  1008.0  } R0 1 1 0 0 ; # for the Instance object NoName_23 
_laygo2_generate_pin EN M3 { { 273.0  360.0  } { 303.0  648.0  } } 1 ; # for the Pin object EN 
_laygo2_generate_pin ENB M3 { { 129.0  360.0  } { 159.0  648.0  } } 2 ; # for the Pin object ENB 
_laygo2_generate_pin I M3 { { 57.0  360.0  } { 87.0  648.0  } } 3 ; # for the Pin object I 
_laygo2_generate_pin O M3 { { 201.0  144.0  } { 231.0  864.0  } } 4 ; # for the Pin object O 
_laygo2_generate_pin VDD M2 { { 0.0  978.0  } { 432.0  1038.0  } } 5 ; # for the Pin object VDD 
_laygo2_generate_pin VSS M2 { { 0.0  -30.0  } { 432.0  30.0  } } 6 ; # for the Pin object VSS 
save
