...
def latch(nf_M6, nf_M7, nf_M10, nf_M12, cellname='latch'):
      cellname = 'latch' 
      print('--------------------')
      ...
      in0 = tnmos.generate(name='M9', params={'nf': nf_M9, 'tie': 'S', 'mosfet': 'nfet_01v8_0p42_nf2'}) # M9, NMOS
      in1 = tnmos.generate(name='M6', params={'nf': nf_M6, 'tie': 'S', 'mosfet': 'nfet_01v8_0p42_nf2'}) # M6, NMOS
      ip0 = tpmos.generate(name='M12', transform='MX', params={'nf': nf_M12, 'tie': 'S', 'mosfet': 'pfet_01v8_0p84_nf2'}) # M12, top PMOS
...
if __name__ == "__main__":
    ...
    latch(nf_M6=2, nf_M7=2, nf_M10=4, nf_M12=6)