...
def inverter(nf_M7, nf_M10, 
                         M7, M10,
                         cellname='inverter'):
      print('--------------------')
      print('Now Creating '+cellname)
      print(f'M7, M10: {M7}, {M10}')
      ...
      in0 = tnmos.generate(name='M7', params={'nf': nf_M7, 'tie': 'S', 'mosfet': M7}) # M7
      ip0 = tpmos.generate(name='M10', transform='MX', params={'nf': nf_M10, 'tie': 'S', 'mosfet': M10}) # M10
...
if __name__ == "__main__":
    ...
    inverter(nf_M7=nf_M7, nf_M10=nf_M10, 
                    M7=M7, M10=M10)
