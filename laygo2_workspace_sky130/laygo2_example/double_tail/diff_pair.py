...
def diff_pair(nf_M1, nf_M3, nf_M5, 
      ...
      in0 = tnmos.generate(name='M5', params={'nf': nf_M5, 'tie': 'S', 'mosfet': M5}) # M5, tail NMOS
      ...
      in3 = tpmos.generate(name='M3', transform='MX', params={'nf': nf_M3, 'tie': 'S', 'mosfet': M3}) # M3, PMOS switch
      in4 = tpmos.generate(name='M4', transform='MX', params={'nf': nf_M4, 'tie': 'S', 'mosfet': M4}) # M4, PMOS switch
