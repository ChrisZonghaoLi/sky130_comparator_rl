...
with open(f'/autofs/fs1.ece/fs1.eecg.tcc/lizongh2/sky130_comparator/xschem/simulations/double_tail_comp.spice', "r") as netlist:
    lines = netlist.readlines()

# generate the LVS compatible netlist for netegn
with open(f'{PWD}/schematic/double_tail_comparator_lvs.spice', "w") as netlist:
    for line in lines:
